                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <form action="/shop/cart" method="post">
                                                ...
                                                <%--                                                        <a href="/shop/cart/delete?id=${o.productId}" class="text-dark">--%>
                        ...
                        <div class="p-4">
                            <ul class="list-unstyled mb-4">
                                <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                        class="text-muted">Tổng tiền hàng</strong><strong>${bill.price} $</strong></li>
                                <c:if test="${bill.delivery > 0}">
                                    <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                            class="text-muted">Phí vận chuyển</strong><strong>${bill.delivery}</strong>
                                    </li>
                                </c:if>
                                <c:if test="${bill.delivery == 0}">
                                    <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                ...
                                <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                        class="text-muted">VAT</strong><strong>${bill.vat} $</strong></li>
                                <li class="d-flex justify-content-between py-3 border-bottom"><strong
